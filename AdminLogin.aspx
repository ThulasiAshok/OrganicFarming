 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="OrganicFarming.AdminLogin" %>
                ...
                <div class="col-lg-7 ">
                    <div class="bg-primary h-100 p-5 ">
                        <form method="post" runat="server">
                            ...
                            <div class="row g-3 ">
                                <div class="col-8  ">
                                <asp:Label ID="Label1" class="form-control  border-0 px-lg-5 " style="text-align:center;border-radius:5px; margin:4px;padding:12px;color:white; background-color: #FF9933" runat="server" Text="Admin Login" Width="625px"></asp:Label>
                                    </div>
                                
                                <div class="row g-3 d-flex justify-content-center">

                                    <div class="col-6">
                                        <asp:TextBox ID="txt_username" class="form-control bg-light border-0 px-lg-5" placeholder="Username" style="height: 55px;border-radius:5px;" runat="server" ></asp:TextBox>
                                    ...
                                    <asp:Button ID="Button1" style="border-radius:5px;" class="form-control  border-0 px-lg-3 " runat="server" Text="Login" OnClick="Button1_Click1"/>
                                     </div>
